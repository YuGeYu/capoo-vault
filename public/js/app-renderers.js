...
export function renderToolsListPage() {
  setPageMeta({
    title: '工具列表',
    description: '猫猫虫咖波表情包仓库工具列表，集中进入 AI 聊天、AI 抠图、慢慢听歌、咖波节奏拍、咖波讯息贴图制作器、灵感工坊和趣味测试。',
    path: '/tools/list'
  });
  app.innerHTML = `
    ${header({
    ...
    <main class="container">
      <section class="site-info-hero">
        <div class="site-info-hero-text">
          ...
          <h2>这里整理了目前可用的小工具</h2>
          <p>现在可以直接使用 AI 聊天、AI 抠图、灵感工坊、慢慢听歌、咖波连连看、咖波节奏拍、咖波讯息贴图制作器、SBTI 人格测试、CSTI 人格测试和 YSTI 原神人格测试，想用哪个就点进去即可。</p>
        </div>
        <div class="review-button-row">
          <a class="site-info-backlink" href="/" data-link>返回首页</a>
        </div>
